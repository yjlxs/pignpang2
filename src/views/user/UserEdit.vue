  ...
  <view class="user-edit">
    ...
    <view class="form-content">
      ...
      <view class="avatar-wrapper">
        <image
          class="user-avatar"
          :src="formData.avatarUrl || '/static/6328.png_860.png'"
          mode="aspectFill"
        />
      </view>
      ...
      <view class="form-section">
        ...
        <view class="radio-group">
          <view 
            ...
            :key="option.value"
            class="radio-item"
            @tap="selectGripStyle(option.value)"
          >
        ...
        <view class="radio-group">
          <view 
            ...
            :key="option.value"
            class="radio-item"
            @tap="selectRacketConfig(option.value)"
          >
...
export default {
  ...
  methods: {
    ...
    // 选择握拍方式
    selectGripStyle(value) {
      this.formData.gripStyle = value
    },
    
    // 选择球拍配置
    selectRacketConfig(value) {
      this.formData.racketConfig = value
    },
    ...
    async handleSave() {
      try {
        ...
        const updatedUserInfo = {
          ...currentUserInfo,
          gripStyle: this.formData.gripStyle,
          racketConfig: this.formData.racketConfig
        }
